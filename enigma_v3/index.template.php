...
<html xmlns="http://www.w3.org/1999/xhtml"', $context['right_to_left'] ? ' dir="rtl"' : '', '><head>
	...
	<link rel="stylesheet" type="text/css" href="http://enigma-dev.org/style.css" />
		...
		<div id="menu">
			<ul>
				<!-- Menu start -->
					...
					<li><a href="/?p=info">Information</a></li>
					<li><a href="/?p=dl">Download</a></li>
					<li><a href="/?p=progress">Progress</a></li>
					<li><a href="/?p=forum"><b>Forum</b></a></li>
				<!-- Menu end -->
...
echo '		</div>
		<div id="footer">
		<!-- SMF -->', theme_copyright(), '<br /><br />
			<!-- Line 1 -->

				<a href="http://a2h.uni.cc/">Design by a2h</a>
				| <a href="http://www.getfirefox.com/">Best viewed in Mozilla Firefox</a><br />
			<!-- Line 2 -->
